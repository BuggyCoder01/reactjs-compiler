...
Symbol {
    ...
    public static Symbol createSymbol(int ScopeId, String name, String value, int lineNumber) {
        ...
        System.out.println("name: " + name +  "      value: " + value + "    scope name: " + scope.getName());
        return symbol;
    }
