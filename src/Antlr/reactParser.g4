...
products:(CONST|LET|VAR)? IDENTIFIER EQUAL OPEN_BRACKET (OPEN_BRACE  name  COMMA description COMMA image COMMA equal2? COMMA  CLOSE_BRACE COMMA)+CLOSE_BRACKET SEMICOLON;
...
equal1:(CONST|LET|VAR)+ IDENTIFIER  EQUAL (STRING_LITERAL|DECIMAL_INTEGER_LITERAL|FLOAT_LITERAL|IDENTIFIER) SEMICOLON ;
